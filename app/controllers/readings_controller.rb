  ...
  private
    ...
    def reading_params
      params.require(:reading).permit(
        :title,
        :earthly_branch_roles_hour,
        :earthly_branch_roles_day,
        :earthly_branch_roles_month,
        :earthly_branch_roles_year,
        :earthly_branch_auspicious_time_hour,
        :earthly_branch_auspicious_time_day,
        :earthly_branch_auspicious_time_month,
        :earthly_branch_auspicious_time_year,
        :earthly_branch_season_hour,
        :earthly_branch_season_day,
        :earthly_branch_season_month,
        :earthly_branch_season_year,
        :earthly_branch_direction_hour,
        :earthly_branch_direction_day,
        :earthly_branch_direction_month,
        :earthly_branch_direction_year,
        :earthly_branch_animal_hour,
        :earthly_branch_animal_day,
        :earthly_branch_animal_month,
        :earthly_branch_animal_year,
        :earthly_branch_element_hour,
        :earthly_branch_element_day,
        :earthly_branch_element_month,
        :earthly_branch_element_year,
        :hour_earthly_branch,
        :day_earthly_branch,
